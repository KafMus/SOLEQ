...
int main(int argc, char* argv[]) {
    ...
    datafile << "NEW ENTRY OF BENCHMARK DATA OF JACOBI SOLVER" << std::endl;
    ...
    kfsoleq::soleq_float max_solver_tolerance  = 0.00000000000001;
    kfsoleq::soleq_float min_solver_tolerance  = 0.0000000000000001;
    kfsoleq::soleq_float solver_tolerance_step = 0.0000000000000012625;
    ...
    for (solver_tolerance = max_solver_tolerance; solver_tolerance >= min_solver_tolerance; solver_tolerance -= solver_tolerance_step) {
        ...
        for (size_t iter_num = 0; iter_num < iters_block_size; ++iter_num) {
            roots = kfsoleq::solverJacobi(solver_tolerance,
