...
int main(int argc, char* argv[]) {
    ...
    datafile << "NEW ENTRY OF BENCHMARK DATA OF CHEBYSHEV ACCELERATOR, ";
    datafile << "TARGET SOLVER: ";
#if TARGET_SOLVER_IND == SOLVER_JACOBI
    datafile << "SOLVER JACOBI";
#elif TARGET_SOLVER_IND == SOLVER_GAUSS_SEIDEL
    datafile << "SOLVER GAUSS SEIDEL";
#elif TARGET_SOLVER_IND == SOLVER_FIXED_POINT_ITERATION
    datafile << "SOLVER FIXED POINT ITERATION";
#endif
    datafile << std::endl;
